...
public class PDFGenerator {
    ...
    public static void generatePatientReport() {
        try {
            ...
            String fileName = "Patient_Report_" + timestamp + ".pdf";
            ...
            Paragraph title = new Paragraph("PROCARE CLINIC - Patient Report", titleFont);
            ...
            String[] headers = {"ID", "First Name", "Last Name", "Date of Birth", "Gender", "Phone"};
            ...
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                while (rs.next()) {
                    table.addCell(new Phrase(String.valueOf(rs.getInt("patient_id")), normalFont));
                    ...
                    table.addCell(new Phrase(rs.getString("gender"), normalFont));
